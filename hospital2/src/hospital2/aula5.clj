...
(let [particular { :id 15, :nome "Guilherme", :nascimento "18/9/1981", :situacao :urgente}
      plano { :id 15, :nome "Guilherme", :nascimento "18/9/1981", :situacao :urgente, :plano [:raio-x, :ultassom]}]
  (pprint (deve-assinar-pre-autorizacao? {:paciente particular, :valor 1000, :procedimento :coleta-de-sagnue}))
  (pprint (deve-assinar-pre-autorizacao? {:paciente plano, :valor 1000, :procedimento :coleta-de-sagnue})))

(let [particular { :id 15, :nome "Guilherme", :nascimento "18/9/1981", :situacao :normal}
      plano { :id 15, :nome "Guilherme", :nascimento "18/9/1981", :situacao :normal, :plano [:raio-x, :ultassom]}]
  (pprint (deve-assinar-pre-autorizacao? {:paciente particular, :valor 1000, :procedimento :coleta-de-sagnue}))
  (pprint (deve-assinar-pre-autorizacao? {:paciente plano, :valor 1000, :procedimento :coleta-de-sagnue})))
